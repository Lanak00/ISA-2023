...
function UpcomingReservationsComponent({ upcomingReservations }) {
    ...
    return (
        <section>
            <UserReservationList reservations = {loadedReservations} isUpcoming={true}/>
        </section>

    );
}

export default UpcomingReservationsComponent;